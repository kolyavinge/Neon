...
void VehicleDebuger::printEngineTorque(Vehicle& vehicle) {
    printf("Trq %i|", (int)vehicle.getEngine().getTorque());
}
...
void VehicleDebuger::printWheelsAngularVelocity(Vehicle& vehicle) {
    printf("Wh %.2f %.2f %.2f %.2f|",
        ...
        vehicle.getWheel(3).getAngularVelocity());
}
...
void VehicleDebuger::printSpringPositions(Vehicle& vehicle) {
    printf("SpringPos (");
    printVector(vehicle.getSpring(0).getPosition());
    printf(") (");
    printVector(vehicle.getSpring(1).getPosition());
    printf(") (");
    printVector(vehicle.getSpring(2).getPosition());
    printf(") (");
    printVector(vehicle.getSpring(3).getPosition());
    printf(")|");
}
