...
public:
    ...
    inline static Vector3 leftVector = Vector3(-1.0f, 0.0f, 0.0f);
    inline static Vector3 rightVector = Vector3(1.0f, 0.0f, 0.0f);
    inline static Vector3 frontVector = Vector3(0.0f, 1.0f, 0.0f);
